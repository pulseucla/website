...
const Home = ({}) => {
    ...
    return(
        <div className='flex flex-col justify-center items-center flex-wrap gap-10 pb-10'>
            ...
            <div className={`bg-[url("/src/assets/hero.png")] xl:w-[1281px] xl:h-[633px] h-[500px] flex flex-col justify-end text-white flex-wrap m-0`}>
                <div className='mb-5 flex-wrap flex-row flex'>
                    <div className='flex items-center justify-left md:ml-[5rem] ml-1 lg:w-[80%]'>
                        <p className='font-medium xl:text-[50px] lg:text-[48px] text-[24px]'> Explore your interest in healthcare </p>
                        <svg width="92" height="31" viewBox="-1 -1 92 31" fill="none" xmlns="http://www.w3.org/2000/svg" className='hidden lg:block'>
                    ...
                    <div className=' flex w-[80%] md:ml-[5rem] ml-1 items-center justify-center flex-wrap flex-row lg:flex-nowrap'>
                        ...
                        >
                            <p className='lg:text-[24px] text-[16px]'>Join our team</p>
                            <svg width="44" height="18" viewBox="0 0 44 18" fill="none" xmlns="http://www.w3.org/2000/svg" className='hidden xl:block'>
            ...
            <div className='xl:hidden flex-col flex'>
            ...
            <div className='overflow-hidden flex-col gap-10 w-[100%] items-center flex m-0 lg:mb-20'>
                <div className='flex-col flex'>
                    <div className='flex-row flex gap-5 items-center'>
                        <p className='md:text-[48px] text-[36px] font-serif'>Get Professional</p>
                    ...
                    <div className='flex-row flex gap-5 items-center'>
                        ...
                        <p className='md:text-[48px] text-[36px]  font-serif'>Development</p>
                    </div>
                    
                </div>
                <div className='flex flex-row flex-wrap xl:flex-nowrap gap-7 justify-center xl:overflow-hidden'>
            ...
            <div className='flex flex-col items-center justify-center gap-20'>
                <div className=' md:w-[50vw] w-[100%]'>
                    <div className='md:text-[48px] text-[36px] font-serif flex-row flex gap-4 items-center'>
                        ...
                        <svg width="55" height="42" viewBox="-1 -1 55 42" fill="none" xmlns="http://www.w3.org/2000/svg" className='hidden md:block'>
